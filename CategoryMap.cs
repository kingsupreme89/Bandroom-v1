...
internal static class CategoryMap
{
    static readonly Dictionary<string, string> ByEvent = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Penalty: Offense"] = "Penalties",
        ["Penalty: Defense"] = "Penalties",

        ["Defense: Timeout (4 Remaining)"] = "Downs",
        ["Defense: Timeout (3 Remaining)"] = "Downs",
        ["Defense: Timeout (2 Remaining)"] = "Downs",
        ["Defense: Timeout (1 Remaining)"] = "Downs",
        ["Defense: Timeout (0 Remaining)"] = "Downs",
    };
